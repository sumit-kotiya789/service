...
- [ ] DB schema: users, agents, contacts, conversations, messages, templates
- [ ] Auth: JWT login for agents
- [ ] Webhook receiver, stubbed WhatsApp sender (console log only)
- [ ] Redis + BullMQ queue for outbound sends
